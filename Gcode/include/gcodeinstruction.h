...
class GcodeInstruction {
  ...
  * @return a gcode instruction of the form "G1 Xx_coordinate Yy_coordinate Zz_coordinate",
  * x_coordinate, y_coordinate, z_coordinate standing for the actual values
  */
  static GcodeInstruction MoveToXYZ(const float x_coordinate, const float y_coordinate, const float z_coordinate);
  ...
  */
  static GcodeInstruction MoveToXY(const float x_coordinate, const float y_coordinate);
  ...
  * and the movement speed of the nozzle are not changed.
  * @param e_filament_extrusion_length the desired length of the extruded filament
  ...
  */
  static GcodeInstruction ExtrudeFilament(const float e_filament_extrusion_length);
