...
PrinterProfile::PrinterProfile(const Point& cut_filament_position,
  ...
  : cut_filament_position_(cut_filament_position),
    ...
    z_coordinate_extruded_filament_above_plates_(z_coordinate_filament_above_plates),
    z_coordinate_extruded_filament_inside_source_plate_(z_coordinate_filament_inside_source_plate),
    z_coordinate_extruded_filament_inside_master_plate_(z_coordinate_filament_inside_master_plate),
    z_coordinate_extruded_filament_inside_goal_plate_(z_coordinate_filament_inside_goal_plate) {
