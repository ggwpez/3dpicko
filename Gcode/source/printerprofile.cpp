...
namespace c3picko {
	...
	PrinterProfile::PrinterProfile(const QJsonObject& obj)
			: JsonConstructable(QJsonObject()),
			  ...
			  cut_filament_position_above_trigger_(Point(obj["cut_filament_position_above_trigger_x"].toString().toDouble(),
														 obj["cut_filament_position_above_trigger_y"].toString().toDouble(),
														 obj["cut_filament_position_above_trigger_z"].toString().toDouble())),
			  distance_between_pushed_trigger_and_gap_between_scissors_blade_(obj["distance_between_pushed_trigger_and_gap_between_scissors_blade"].toString().toDouble()),
			  filament_extrusion_length_on_move_(obj["filament_extrusion_length_on_move_offset"].toString().toDouble()),
			  z_coordinate_pushing_the_trigger_(obj["z_coordinate_pushing_the_trigger"].toString().toDouble()),
			  filament_extrusion_length_on_pick_and_put_onto_master_plate_(obj["filament_extrusion_length_on_pick_and_put_onto_master_plate_offset"].toString().toDouble()),
