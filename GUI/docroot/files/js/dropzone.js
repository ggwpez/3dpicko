...
(function ( $, window, document, undefined ) {
    ...
    defaults = {
            ...
            text:                   'Bilder hinzufügen',            //text inside the div
    ...
    Plugin.prototype.init = function () {
        ...
        if(typeof $(this.element).attr('src') !== 'undefined'){
            ...
            clone.replaceWith('<img class="previewImg" style="width:30px" src="'+src+'" />');
...
function upload(that, files){
    if(that.options.preview){
        ...
        clone.replaceWith('<img class="previewImg" style="width:30px"/>');
