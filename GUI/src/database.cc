...
Database::DetectionResultTable& Database::detectionResults() { return detection_results_; }
...
AlgorithmJob::ID Database::newResultJobId() { return QString::number(result_job_id_++); }
...
void Database::setdefaultPrinter(const Profile::ID& default_printer) { default_printer_ = default_printer; }

void Database::setDefaultSocket(const Profile::ID& default_socket) { default_socket_ = default_socket; }

void Database::setDefaultPlate(const Profile::ID& default_plate) { default_plate_ = default_plate; }
} // namespace c3picko
