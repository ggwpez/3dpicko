...
HttpListener::HttpListener(QSettings* settings, QSslConfiguration* ssl, HttpRequestHandler* requestHandler, QObject* parent)
...
void HttpListener::listen()
{
	...
	{
		qInfo("HttpListener: Listening on port %i", port);
	}
}
