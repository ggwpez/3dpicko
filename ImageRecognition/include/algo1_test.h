...
public:
  ...
  static void threshold(Algorithm *base, const cv::Mat *input,
                        cv::Mat **output);
  static void erodeAndDilate(Algorithm *base, const cv::Mat *input,
                             cv::Mat **output);
  static void label(Algorithm *base, const cv::Mat *input,
                    std::vector<Colony> **output);
  static void relativeFiltering(Algorithm *base, std::vector<Colony> *input,
                                std::vector<Colony> **output);
