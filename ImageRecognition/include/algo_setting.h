...
class AlgoSetting
{
  public:
	...
	static AlgoSetting make_checkbox(ID id, QString name, QString description, bool default_value);
	...
	AlgoSetting(ID id, QString name, QString type, QString description, QVariant min, QVariant max, QVariant step, QStringList enum_values,
