 ...
 * @brief The Conversion class is responsible for converting settings and
 * coordinates.
 */
...
public:
  /**
   * @brief The createColonyCoordinates function: creates the positions of the
   * colonies.
  ...
  createColonyCoordinates(std::vector<cv::Vec3f> positions, int cols, int rows);

  /**
   * @brief The createDishCoordinates function: creates the positions of the
   * petri dish.
   ...
   */
  static std::vector<cv::Vec3f>
  createDishCoordinates(std::vector<cv::Vec3f> positions, int cols, int rows);

  /**
   * @brief The convertSettings function: converts settings from json to
   * detectionSettings.
