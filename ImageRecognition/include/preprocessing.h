...
public:
  /**
   * @brief The preprocessing function is used to preporcess the image so that
   * the image recognition can work
   * @param src: original image.
   * @param dest: manupilated image.
   * @param settings: settings to be applied.
   */
  static void preprocessing(cv::Mat src, cv::Mat &dest,
