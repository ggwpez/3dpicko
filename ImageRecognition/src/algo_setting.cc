...
AlgoSetting AlgoSetting::make_dropdown(AlgoSetting::ID id, QString name, QString description, QStringList values, int default_value_index)
{
	return AlgoSetting(id, name, "dropdown", description, empty_qv, empty_qv, empty_qv, values, default_value_index);
}
...
AlgoSetting::AlgoSetting(AlgoSetting::ID id, QString name, QString type, QString description, QVariant min, QVariant max, QVariant step,
						 QStringList enum_values, QVariant default_value, QVariant value)
	: id_(id), name_(name), type_(type), description_(description), min_(min), max_(max), step_(step), enum_values_(enum_values),
...
template <> AlgoSetting Marshalling::fromJson(const QJsonObject& obj)
{
	...
	else if (type == "dropdown")
	{
		...
		return AlgoSetting(id, name, "dropdown", description, empty_qv, empty_qv, empty_qv, enum_values, default_value);
	}
	else
