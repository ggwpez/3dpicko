...
private:
  ...
  std::tuple<int, std::vector<Node>, int>
  SolveGreedyMax(int h, std::vector<Node> binary_heap);
  std::tuple<int, std::vector<Node>, int>
  SolveGreedyMin(int h, std::vector<Node> binary_heap);
  std::tuple<int, std::vector<Node>>
  SolveRandomBetweenMinAndMax(int h, std::vector<Node> binary_heap,
                              const int amount_of_min_number_of_collisions,
                              const int amount_of_max_number_of_collisions,
                              std::mt19937_64 &rng);
  ...
  void
  EvaluateRandomBetweenMinAndMax(std::vector<Node> &current_state, int &h,
                                 const int amount_of_min_number_of_collisions,
                                 const int amount_of_max_number_of_collisions,
                                 std::mt19937_64 &rng);
  ...
  std::vector<Colony>
  MapNodesToColonies(const std::vector<Node> &nodes_solution);
