...
class DtorCallback
{
  public:
	enum class CallType
	{
		...
		kONLY_IN_EXC_CONTEXT,   // only called when the destructor is called from stack unwinding
		kONLY_IN_NO_EXC_CONTEXT // only called when the destructor is not called from stack unwinding
	};
