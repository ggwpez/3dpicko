  ...
  json["settings"] = {
	  {makeNumberField("number_of_rows", "Number of rows", "", 1, 100, 1, 0, 0,
	   ...
	   makeNumberField("times_to_lower_filament_into_well",
					   "# Lower filament into Well", "The number of times that the filament should be lowered into the well.", 1, 100, 1, 2, 2, ""),
	   makeNumberField("red_frame_width", "Red Frame width", "Width of the red frame that is placed on the source plate.",
					   1, 1000, 0.01, 128, 128, "mm"),
	   makeNumberField("red_frame_height", "Red Frame height", "Height of the red frame that is placed on the source plate.",
					   1, 1000, 0.01, 128, 128, "mm")}};
