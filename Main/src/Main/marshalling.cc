...
template <> QJsonObject Marshalling::toJson(const PrinterProfile& value)
{
	...
	obj["filament_extrusion_length_on_move_cut_to_pick"]	= value.filamentExtrusionLengthOnMoveCutToPick();
	obj["filament_extrusion_length_on_move_pick_to_master"] = value.filamentExtrusionLengthOnMovePickToMaster();
	obj["filament_extrusion_length_on_move_master_to_goal"] = value.filamentExtrusionLengthOnMoveMasterToGoal();
	obj["filament_extrusion_length_on_move_goal_to_cut"]	= value.filamentExtrusionLengthOnMoveGoalToCut();
	obj["filament_extrusion_length_on_pick"]				= value.filamentExtrusionLengthOnPick();
	obj["filament_extrusion_length_on_put_onto_master"]		= value.filamentExtrusionLengthOnPutOntoMaster();
	obj["filament_extrusion_length_after_cut"]				= value.filamentExtrusionLengthAfterCut();
...
template <> PrinterProfile Marshalling::fromJson(const QJsonObject& obj)
{
	return PrinterProfile(
		obj["movement_speed"].toInt(), Marshalling::fromJson<Point>(obj["cut_filament_position_above_trigger"].toObject()),
		obj["z_coordinate_pushing_the_trigger"].toDouble(), obj["filament_extrusion_length_on_move_cut_to_pick"].toDouble(),
		...
		obj["filament_extrusion_length_on_move_goal_to_cut"].toDouble(), obj["filament_extrusion_length_on_pick"].toDouble(),
		obj["filament_extrusion_length_on_put_onto_master"].toDouble(), obj["filament_extrusion_length_after_cut"].toDouble(),
		obj["length_of_removed_filament"].toDouble(),
		obj["safety_distance_between_top_surface_of_all_plates_and_nozzle_on_"
			"move"]
			.toDouble(),
		obj["skip_source"].toBool(false), obj["skip_master"].toBool(false), obj["skip_target"].toBool(false),
		obj["skip_cutoff"].toBool(false));
}
...
template <> PlateSocketProfile Marshalling::fromJson(const QJsonObject& obj)
{
	...
	return PlateSocketProfile(Marshalling::fromJson<Point>(obj["global_origin_of_source_plate"].toObject()),
							  ...
							  Marshalling::fromJson<QString>(obj["orientation_of_goal_plate"]) == "kFirstRowFirstColumnAtCutoutOrigin"
							  ...
							  obj["depth_of_cutout_the_goal_plate_lies_in"].toDouble(), socket_origin_offset.xCoordinate(),
							  socket_origin_offset.yCoordinate(), socket_origin_offset.zCoordinate());
}
...
template <> QJsonObject Marshalling::toJson(const PlateProfile& value)
{
	...
	obj["plate_type"]							 = (value.plateType() == PlateType::kROUND ? "kROUND" : "kRECT");
	...
	obj["culture_medium_thickness_source_plate"] = value.cultureMediumThicknessSourcePlate();
	obj["culture_medium_thickness_master_plate"] = value.cultureMediumThicknessMasterPlate();
	obj["times_to_lower_filament_into_well"]	 = value.timesToLowerFilamentIntoWell();
...
{
	return PlateProfile(obj["number_of_rows"].toInt(), obj["number_of_columns"].toInt(),
						(obj["plate_type"].toString() == "kROUND" ? PlateType::kROUND : PlateType::kRECT), obj["a1_row_offset"].toDouble(),
						...
						obj["well_depth"].toDouble(), obj["culture_medium_thickness_source_plate"].toDouble(),
						obj["culture_medium_thickness_master_plate"].toDouble(), obj["times_to_lower_filament_into_well"].toInt());
}
...
template <> cv::Point2d Marshalling::fromJson(const QJsonObject& obj) { return {obj["x"].toDouble(), obj["y"].toDouble()}; }

template <> QJsonObject Marshalling::toJson(const cv::Point2d& value) { return {{"x", value.x}, {"y", value.y}}; }

template <> cv::Point2i Marshalling::fromJson(const QJsonObject& obj) { return {obj["x"].toInt(), obj["y"].toInt()}; }

template <> QJsonObject Marshalling::toJson(const cv::Point2i& value) { return {{"x", value.x}, {"y", value.y}}; }

template <> cv::Rect2i Marshalling::fromJson(const QJsonObject& obj)
{
	return {obj["x"].toInt(), obj["y"].toInt(), obj["w"].toInt(), obj["h"].toInt()};
}

template <> QJsonObject Marshalling::toJson(const cv::Rect2i& value)
{
	return {{"x", value.x}, {"y", value.y}, {"w", value.width}, {"h", value.height}};
}

template <> QSet<qint32> Marshalling::fromJson(const QJsonObject& obj)
{
...
template <> QJsonObject Marshalling::toJson(const QSet<qint32>& value)
{
	QJsonObject obj;
	QJsonArray  elements;
...
template <> QSet<QString> Marshalling::fromJson(const QJsonObject& obj)
{
	QJsonArray	elements = obj["elements"].toArray();
	QSet<QString> ret;
...
template <> QJsonObject Marshalling::toJson(const QSet<QString>& value)
{
	QJsonObject obj;
	QJsonArray  elements;
