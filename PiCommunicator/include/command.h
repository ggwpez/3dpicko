...
class Command : public QObject
{
  ...
  public:
	Command(QString api_url, QByteArray data, QSet<int> status_ok, QString content_type = "application/json; charset=utf-8");
	Command(QString api_url, QJsonObject data, QSet<int> status_ok, QString content_type = "application/json; charset=utf-8");
	~Command();
